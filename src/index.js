...
document.querySelector("#submit-data").addEventListener("click", (event) => {
  event.preventDefault();
  const inputValue = document.querySelector("#input-area").value;
  municipalityCode = inputValue.toUpperCase();
  fetchData(municipalityCode);
});
